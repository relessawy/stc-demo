...
public class Vacation implements java.io.Serializable {
	...
	public Vacation(java.lang.String firstName, java.lang.String lastName, int hours, java.lang.String id) {
		this.firstName = firstName;
		this.lastName = lastName;
		this.hours = hours;
		this.id = id;
	...
	public String toString() {
		return "Vacation [firstName=" + firstName + ", lastName=" + lastName + ", hours=" + hours + ", id=" + id + "]";
	}
